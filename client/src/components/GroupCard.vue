...
export default {
  ...
  methods:{
    add(val){
      ...
      axios.post('http://0.0.0.0:3000/addg',this.lst).then((res) => {
            console.log('success')
          }).catch((err) => {
            console.log('error')
          })
    ...
    remove(val){
      ...
      this.lst['group']=val
      console.log(this.lst)
      axios.post('http://0.0.0.0:3000/removeg',this.lst).then((res) => {
            console.log('success')
          }).catch((err) => {
            console.log('error')
          })
  ...
  created(){
        ...
        axios.post('http://0.0.0.0:3000/getg',this.lst2).then((res) => {
