<template>
  ...
  >
    ...
    >
      <a-upload name="file" :multiple="true" action="http://0.0.0.0:3000/fileupload" :headers="headers" @change="handleChange">
    ...
    >
      <a-Row :gutter="8">
        ...
        <a-Col :span="12">
          <a-upload name="file" :multiple="true" action="http://0.0.0.0:3000/barcode" :headers="headers" @change="handleChange2">
    ...
    handleSubmit (e) {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          values['img'] = this.img
          // console(values)
          axios.post('http://0.0.0.0:3000/save', values).then((res) => {
            console.log('success')
            this.$swal({
                title: 'Are you sure?',
